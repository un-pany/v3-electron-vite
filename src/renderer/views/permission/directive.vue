    ...
    <div class="app-container">
        ...
        <div :key="key" class="margin-top">
            <div>
                ...
                <el-tag v-permission="['admin']" class="permission-code" type="info" size="large"> v-permission="['admin']" </el-tag>
            </div>
            <div>
                ...
                <el-tag v-permission="['editor']" class="permission-code" type="info" size="large"> v-permission="['editor']" </el-tag>
            </div>
            <div>
